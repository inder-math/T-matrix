...
C   any damages that may result from the use of the program. 
     ...
     &       BET2(NPL),MRR,MRI,LAM                                            
      open (6, file='r_0.8/miedata/output_1000.dat')
      open (10, file='r_0.8/miedata/expan_1000.dat')
      open (20, file='r_0.8/miedata/scat_1000.dat')
      AA=0.68D0
      BB=0.181D0
c     AA1=0.17D0
c     AA2=3.44D0
...
c         F34=100d0*F34/F11
         ...
         WRITE (20,1004) TB,F11,F33,F12,F34
  500 CONTINUE
...
C  PRINTOUT   **********************************************************        
  ...
  515 FORMAT ('REFF=',d12.6,'   VEFF=',d12.6)      
      ...
      WRITE (6,500) LAM,MRR,MRII                                     
  500 FORMAT('LAM =',F8.4,'  MRR=',F7.3,'  MRI=',F8.5)            
...
c      WRITE (10,580) ALB,L1MAX
  560 FORMAT('   S         ALPHA 1        ALPHA 2        ALPHA 3',
     *'        ALPHA 4         BETA 1         BETA 2')
      WRITE (10,560)
      DO L=1,L1MAX
         LL=L-1
         WRITE (10,575) LL ,AL1(L),AL2(L),AL3(L),AL4(L),BET1(L),BET2(L)           
      ENDDO   
  575 FORMAT(I4,1X,6D15.7)
  580 FORMAT(D14.8,I8)
      RETURN                                                                    
      END                                                                       
